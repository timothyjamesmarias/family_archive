...
# Web dashboard for Solid Queue jobs, mounted under /admin/jobs
...
# S3 storage for Active Storage in production (Render's disk is ephemeral)
...
group :development do
  ...
  # Open sent mail in the browser instead of delivering it
  gem "letter_opener"
end
